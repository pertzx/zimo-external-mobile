...
namespace ImGui
{
    ...
    IMGUI_API bool          Tab(const char* Label, const char* Icon, bool Enabled); // ImGui::SearchBar(const char* str_id, const ImVec2& size)
    IMGUI_API bool          SearchBar(const char* str_id, const ImVec2& size);
    ...
    IMGUI_API bool          Button(const char* label, const ImVec2& size_arg, int buttonnumber); //button
    ...
    IMGUI_API bool          Checkbox(const char* label, bool* v); //CheckboxRisk
    IMGUI_API bool          CheckboxRisk(const char* label, bool* v);
    ...
    IMGUI_API bool          BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags, int itemcount);
