// zygisk.hpp - Zygisk API v3 (CORRECT VERSION for Magisk 30.7+)
// Based on the working version used by Rama Modz (com.dts.freefireth)
//
// CRITICAL: Magisk 30+ uses ZYGISK_API_VERSION 3, NOT 2.
// Using v2 will cause "failed to fill whole buffer" + Zygote crash.
