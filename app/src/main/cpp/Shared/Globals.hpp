...
namespace Cheat {
	...
	public:
		struct AimBot
		{
			...
			bool PraCima = false;
			int KeyBind = 0x2F; // CODIGO DE TECLA GENERICO;
			bool aimmagnect = false;
			int MagKey = 0x2F; // CODIGO DE TECLA GENERICO;
			bool ghost = false;
			int ghostkey = 0x2F; // CODIGO DE TECLA GENERICO;
			int TPKey = 0;
			bool TP = false;
			int CityIndex = 0;
			int Fov = 360;
		...
		struct General
		{
			int MenuKey = 0x2F; // CODIGO DE TECLA GENERICO;
			int ThreadDelay = 240;
